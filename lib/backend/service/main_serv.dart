  ...
  */
  ...
  Future<List<SinIntervencionModel>> getSinIntervencion(
    ...
    List<SinIntervencionModel> aResp =
        await Get.find<MainRepo>().getSinIntervencion(sOpcion);
    return aResp;
  }
  ...
  Future<List<ProgIntervencionTamboModel>> getProgIntervencion(
    ...
    List<ProgIntervencionTamboModel> aResp =
        await Get.find<MainRepo>().getProgIntervencion(
      numSnip,
      anio,
      xMes,
      tipo,
  ...
  Future<List<PriorizacionModel>> getPriorizacion(
    ...
    List<PriorizacionModel> aResp =
        await Get.find<MainRepo>().getPriorizacion(idTambo);
    return aResp;
  }
  ...
  Future<List<AtencionesUsuariosTotalModel>> getCantidadTotalMetas(
    ...
    List<AtencionesUsuariosTotalModel> aResp =
        await Get.find<MainRepo>().getCantidadTotalMetas(anio);
    return aResp;
  }
  ...
  Future<List<ActividadesDiariasResumenModel>> getActividadesDiariasResumen(
    ...
    List<ActividadesDiariasResumenModel> aResp =
        await Get.find<MainRepo>().getActividadesDiariasResumen(fecha);
    return aResp;
  }
  ...
  Future<List<BuscarTamboDto>> getDatosTamboGestor(String idTambo) async {
    List<BuscarTamboDto> aResp =
        await Get.find<MainRepo>().getDatosTamboGestor(idTambo);
    return aResp;
  }
