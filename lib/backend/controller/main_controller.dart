...
class MainController extends GetxController {
  ...
  */
  ...
  Future<List<SinIntervencionModel>> SinIntervencion(
    String? sOpcion,
  ) async {
    List<SinIntervencionModel> aResp =
        await Get.find<MainService>().getSinIntervencion(sOpcion);
    return aResp;
  }
  ...
  Future<List<ProgIntervencionTamboModel>> progIntervencionTambo(
    ...
    /**
     * tipoProgramacion:
     * 1 : PS: INTERVENCIONES PRESTACION SERCICIOS
     * 3 : ES: INTERVENCIONES SOPORTE
     * 2 : Actividades GIT
     */
    List<ProgIntervencionTamboModel> aResp =
        await Get.find<MainService>().getProgIntervencion(
      numSnip,
      anio,
      xMes,
      tipo,
  ...
  Future<List<ImagenJUTModel>> obtenerImagenJUT(
    ...
    List<ImagenJUTModel> aResp =
        await Get.find<MainService>().obtenerImagenJUT(numSnip);
    return aResp;
  }
  ...
  Future<List<PlanMantenimientoInfraestructuraModel>>
      planMantenimientoInfraestructura(
    String? snip,
  ) async {
    List<PlanMantenimientoInfraestructuraModel> aResp =
        await Get.find<MainService>().getPlanMantenimientoInfraestructura(snip);
    return aResp;
  }
  ...
  Future<List<PersonalPuestoModel>> getPersonalPuesto() async {
    List<PersonalPuestoModel> aResp =
        await Get.find<MainService>().getPersonalPuesto();
    return aResp;
  }
  ...
  Future<List<EquipamientoInformaticoModel>> getEquipamientoInformatico(
    ...
    List<EquipamientoInformaticoModel> aResp =
        await Get.find<MainService>().getEquipamientoInformatico(snip);
    return aResp;
  }
  ...
  Future<List<AvanceMetasModel>> getAvanceMetasMensualizada(String anio) async {
    List<AvanceMetasModel> aResp =
        await Get.find<MainService>().getAvanceMetasMensualizada(anio);
    return aResp;
  }

  Future<List<AtencionesSectorialesModel>> getReporteSectorial(
      String tipo, String anio, String mes, String sector) async {
    List<AtencionesSectorialesModel> aResp = await Get.find<MainService>()
        .getReporteSectorial(tipo, anio, mes, sector);
    return aResp;
  }

  Future<List<AtencionesRegionModel>> getReporteAtencionesRegion(
      String anio, String mes, String region) async {
    List<AtencionesRegionModel> aResp = await Get.find<MainService>()
  ...
  Future<List<IndicadorInternetModel>> getIndicadorInternet(
    ...
    List<IndicadorInternetModel> aResp =
        await Get.find<MainService>().getIndicadorInternet(idTipo);
    return aResp;
  }
  ...
  Future<List<ListaTambosEstadoInternetModel>> getListaTambosEstadoInternet(
    ...
    List<ListaTambosEstadoInternetModel> aResp =
        await Get.find<MainService>().getListaTambosEstadoInternet(idEstado);
    return aResp;
  }

  Future<List<TambosEstadoInternetModel>> getIndicadorEstadoInternet() async {
    List<TambosEstadoInternetModel> aResp =
        await Get.find<MainService>().getIndicadorEstadoInternet();
    return aResp;
  }
  ...
  Future<List<IndicadorCategorizacionModel>> getIndicadorCategorizacion(
    ...
    List<IndicadorCategorizacionModel> aResp =
        await Get.find<MainService>().getIndicadorCategorizacion(idTipo);
    return aResp;
  }

  Future<List<ServiciosBasicosResumenModel>>
      getIndicadorResumenServiciosBasicos(String opcion, String tipo) async {
    List<ServiciosBasicosResumenModel> aResp = await Get.find<MainService>()
  ...
  Future<List<CategorizacionTambosModel>> getCategorizacionTambos(
    ...
    List<CategorizacionTambosModel> aResp =
        await Get.find<MainService>().getCategorizacionTambos(idTipo);
    return aResp;
  }
  ...
  Future<List<ProgramacionMantenimientoModel>> getProgramacionMantenimiento(
    ...
    List<ProgramacionMantenimientoModel> aResp =
        await Get.find<MainService>().getProgramacionMantenimiento(nomUT);
    return aResp;
  }
