...
import 'package:actividades_pais/src/dto/Event.dart';
import 'package:actividades_pais/src/pages/Tambook/historialTambo/fichaIntervencion.dart';
import 'package:actividades_pais/src/pages/widgets/pdf/pdf_preview_page2.dart';
                              ...
                              return Container(
                                ...
                                child: InkWell(
                                    onTap: () async {
                                      ...
                                      // In Android we need to request the storage permission, while in iOS is the photos permission
