...
class ProviderTambok {
  static Future<List<TamboServicioIntervencionesGeneral>> getPosts(
    ...
    print(
        '${AppConfig.urlBackndServicioSeguro}/api-pnpais/tambook/app/tamboServicioIntervencionesGeneral/1/$page/$limit');
    ...
    if (response.statusCode == 200) {
      ...
      final lista = ListarTamboServicioIntervencionesGeneral.fromJsonList(
  ...
  Future<List<TamboServicioIntervencionesGeneral>>?
    ...
    print(Uri.parse(
        '${AppConfig.urlBackndServicioSeguro}/api-pnpais/tambook/app/tamboServicioIntervencionesGeneral/$tipo/$sector/$gobierno/$pag/$sizePag'));
    ...
    if (response.statusCode == 200) {
      ...
      lista = ListarTamboServicioIntervencionesGeneral.fromJsonList(
          jsonResponse["response"]);
  ...
  Future<List<TipoGobiernoResponse>>? obtenerTipoGobierno(tipo) async {
    http.Response response = await http.get(
      Uri.parse(
          '${AppConfig.urlBackndServicioSeguro}/api-pnpais/tambook/app/obtenerTipoGobiernoSector/$tipo'),
    );
    // print(response.body);
    if (response.statusCode == 200) {
      List.empty();
